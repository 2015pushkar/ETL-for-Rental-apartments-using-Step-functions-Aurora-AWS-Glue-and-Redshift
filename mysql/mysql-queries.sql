mysql --local-infile=1 -h rental-apartments-db.cluster-cuvswceomyn1.us-east-1.rds.amazonaws.com -P 3306 -u admin -p
...
LOAD DATA LOCAL INFILE '/mnt/d/ETL-for-Rental-apartments-using-Step-functions-Aurora-AWS-Glue-and-Redshift/data/apartments.csv'
INTO TABLE rental_apartments.apartments
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES  TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/mnt/d/ETL-for-Rental-apartments-using-Step-functions-Aurora-AWS-Glue-and-Redshift/data/apartment_attributes.csv'
INTO TABLE rental_apartments.apartment_attributes
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES  TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE '/mnt/d/ETL-for-Rental-apartments-using-Step-functions-Aurora-AWS-Glue-and-Redshift/data/user_viewings.csv'
INTO TABLE rental_apartments.apartment_viewings
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES  TERMINATED BY '\n'
IGNORE 1 ROWS;
